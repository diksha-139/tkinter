...
app_label = Label(window, text="BMI CALCULATOR", fg = "red", bg = "yellow", font=("Calibri", 20),bd=5)
...
calculate_button=Button(window,text="CALCULATE",fg = "red", bg = "lime",bd=4,command=calculate_bmi)
